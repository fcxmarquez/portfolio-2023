...
export const homieStartupDescription = (
  <>
    <ul>
      <li>Real-state Mexican startup</li>
      <li>
        Led Homie&apos;s Component Library creation, accelerating project delivery through
        efficient component utilization.
      </li>
      <li>
        Streamlined communication between design and development teams via an interactive
...
export const finspheraDescription = (
  <>
    <ul>
      <li>Actually working as a Frontend Engineer</li>
      <li>Preparing new awesome projects!</li>
    </ul>
  </>
);
